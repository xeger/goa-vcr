...
- `go run goa.design/goa/v3/cmd/goa@v3.23.4 gen ...` generates normal Goa `gen/` + `gen/http/` output **plus** `gen/http/toy/vcr` (because the design blank-imports the plugin).
